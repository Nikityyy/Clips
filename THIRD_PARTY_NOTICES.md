...
The optional Google Flow integration bundles and runs gflow-cli 0.79.1 and uv 0.12.18. Both are MIT-licensed and remain separate third-party programs; their license texts are included in the application resources at `licenses/MIT-gflow-cli.txt` and `licenses/MIT-uv.txt`. Their source repositories are [gflow-cli](https://github.com/ffroliva/gflow-cli) and [uv](https://github.com/astral-sh/uv).
